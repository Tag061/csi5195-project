...
def main(csv_path, model_id="Qwen/Qwen1.5-7B-Chat", output_filename='qwen1.5_jailbreak_response.csv', device="cuda"):
...
if __name__ == '__main__':
    ...
    main(args.csv_path, args.model_id, args.output_filename, args.device)